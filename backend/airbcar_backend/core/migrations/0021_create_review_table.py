            ...
            database_operations=[
                migrations.RunSQL(
                    sql="""
                        ...
                        CREATE UNIQUE INDEX IF NOT EXISTS "core_review_unique_booking_review" 
                            ON "core_review" ("booking_id") 
                            WHERE "booking_id" IS NOT NULL;
                    """,
                    reverse_sql="""
                        DROP INDEX IF EXISTS "core_review_unique_booking_review";
