...
class User(AbstractUser):
    ...
    license_front_document = models.ImageField(upload_to='user_documents/license_documents/', blank=True, null=True, help_text='Front side of driver license')
    license_back_document = models.ImageField(upload_to='user_documents/license_documents/', blank=True, null=True, help_text='Back side of driver license')
