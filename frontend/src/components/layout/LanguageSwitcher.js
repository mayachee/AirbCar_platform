...
export default function LanguageSwitcher() {
  ...
  return (
    <SelectField
      ...
      className="w-full rounded-xl bg-white/5 hover:bg-white/10 border border-gray-300 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700/60 focus:ring-orange-500/50 focus:border-orange-500/50 transition-colors"
    />
  );
}
