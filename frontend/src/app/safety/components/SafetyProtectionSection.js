    ...
    <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto">
                ...
                >
                     <div className="inline-block px-4 py-1.5 rounded-full border border-orange-500/30 bg-orange-500/10 text-orange-400 text-sm font-semibold mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <motion.div 
                            ...
                            className="bg-white/5 backdrop-blur-md border border-white/5 p-8 rounded-3xl relative group overflow-hidden hover:bg-white/10 transition-colors duration-500"
                        >
                            <div className="absolute top-0 right-0 w-24 h-24 bg-orange-500/10 rounded-full blur-2xl -mr-12 -mt-12 group-hover:bg-orange-500/20 transition-colors duration-500" />
                            
                            <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-orange-400 transition-colors duration-300">
                                {item.title}
                            </h3>
                            <div className="h-1 w-12 bg-orange-500/50 rounded-full mb-6 group-hover:w-20 transition-all duration-300" />
