      ...
      <div className="bg-white rounded-none shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-8 py-12 text-center">
          <div className="relative inline-block mb-4">
            <div className="w-20 h-20 bg-white rounded-none flex items-center justify-center shadow-lg">
              <svg className="w-10 h-10 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <div className="absolute -bottom-2 -right-2">
              <div className="w-6 h-6 bg-orange-500 rounded-none border-2 border-white flex items-center justify-center">
        ...
        <div className="p-8">
          ...
          <div className="bg-gray-50 rounded-none p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="bg-white rounded-none p-4 border border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 bg-yellow-500 rounded-none animate-pulse"></div>
            ...
            {totalAmountValue && (
              <div className="mt-4 bg-orange-50 rounded-none p-4 border border-orange-200">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-none p-6 mb-6">
            ...
            <ol className="space-y-3 text-sm text-blue-800">
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-none flex items-center justify-center text-xs font-bold">1</span>
                <span>{t('step1')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-none flex items-center justify-center text-xs font-bold">2</span>
                <span>{t('step2')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-none flex items-center justify-center text-xs font-bold">3</span>
                <span>{t('step3')}</span>
              </li>
            </ol>
          </div>
          ...
          {/* Info Box */}
          <div className="bg-amber-50 border border-amber-200 rounded-none p-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="flex-1 bg-orange-500 text-white px-6 py-3 rounded-none hover:bg-orange-600 transition-all shadow-lg shadow-orange-500/30 hover:shadow-xl font-semibold flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            ...
            <button
              onClick={() => router.push('/')}
              className="flex-1 border-2 border-gray-300 text-gray-700 px-6 py-3 rounded-none hover:bg-gray-50 transition-all font-semibold flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
