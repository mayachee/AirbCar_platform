...
import { Star, Award, Share2, Heart, MessageCircle, Bookmark, Settings, Bolt } from 'lucide-react'
...
export default function PartnerProfileClient({ initialPartner = null, initialListings = [] }) {
  ...
  const logoUrl = partnerData?.logo || partnerData?.logo_url || partnerData?.profile_image || partnerData?.user?.profile_picture || partnerData?.user?.profile_picture_url || "https://lh3.googleusercontent.com/aida-public/AB6AXuDLXehMLNX8QNR84qihA7ZKLnm_o_1zHT7br_WGmUOIzEvTXo_tmrBh5NGRqj7zFTS6Tu948bP_QeiZ8zYTEOjSz0hiEDQk6FZIImPvduA78LMHLCu_AHfKTmTmu3MFGlGKyhnY3PanKWAwMmUlgzjTaz-ctCmoAQNgGk0SNB42k3BxDZwPoluAYQ8PkWDiJymzy6ghxJ5uln2Y26BmNpiLWFSepPmGcBM-4Jh2Vd8FCyfGQPN8CBkoHdoR_LguzascwcvzQ710KhU"
      ...
      <main className="min-h-screen pb-20">
        <section className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <div className="bg-kc-surface-container-lowest p-8 rounded-3xl shadow-sm border border-kc-outline-variant/30 flex flex-col items-center text-center">
              <div className="flex items-center gap-2">
                <span className="text-4xl font-black text-kc-on-surface tracking-tighter">{Number(rating).toFixed(1)}</span>
            ...
            <div className="space-y-6 pt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-kc-surface-container-lowest p-8 rounded-3xl border border-kc-outline-variant/30 shadow-sm">
                  ...
                  <p className="text-kc-on-surface-variant italic leading-relaxed mb-6">&ldquo;Absolute seamless experience from pickup to drop-off. The {companyName} team knows how to treat their clients. The G-Wagon was immaculate.&rdquo;</p>
                ...
                <div className="bg-kc-surface-container-lowest p-8 rounded-3xl border border-kc-outline-variant/30 shadow-sm">
                  ...
                  <p className="text-kc-on-surface-variant italic leading-relaxed mb-6">&ldquo;I appreciate the attention to detail. The route planning they provided with the rental made our anniversary trip unforgettable.&rdquo;</p>
                  <div className="flex items-center gap-3">
                  ...
                  <div key={car.id || index} className="group bg-kc-surface-container-lowest rounded-3xl overflow-hidden border border-kc-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div className="h-48 overflow-hidden relative">
                      <img
                        ...
                        className="w-full h-full object-cover"
                        src={car.images?.[0]?.image_url || car.images?.[0]?.image || car.images?.[0] || "https://images.unsplash.com/photo-1611016186353-9af58c69a533?w=800"}
                      />
                    ...
                    <div className="p-6">
                      <h5 className="font-bold text-lg text-kc-on-surface mb-4">{car.brand || car.make} {car.model}</h5>
