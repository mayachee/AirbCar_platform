    ...
    <div className="space-y-6">
      ...
      {user && canReview && !showForm && (
        <motion.button
          ...
          className="w-full py-4 px-6 bg-orange-500 hover:bg-orange-600 text-white rounded-2xl font-extrabold shadow-sm shadow-orange-500/30 transition-all flex items-center justify-center space-x-2"
        >
