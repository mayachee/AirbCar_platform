    ...
    <section className="py-12 md:py-20 px-4">
      <div className="container mx-auto max-w-5xl">
        <motion.div
            ...
            className="relative rounded-none md:rounded-[3rem] overflow-hidden bg-[#15171e] border border-white/10 p-8 md:p-20 text-center group"
        >
            {/* Background Decorations */}
             <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20" />
            
            {/* Ambient Colors */}
            <div className="absolute -top-1/2 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-b from-orange-500/10 to-transparent rounded-none blur-[100px] group-hover:bg-orange-500/20 transition-colors duration-1000" />
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-amber-500/5 rounded-none blur-[80px]" />

            <div className="relative z-10 space-y-6 md:space-y-8">
                <div className="inline-flex items-center justify-center p-3 md:p-4 rounded-none bg-white/5 border border-white/5 backdrop-blur-xl mb-2 md:mb-4 group-hover:scale-110 transition-transform duration-500">
