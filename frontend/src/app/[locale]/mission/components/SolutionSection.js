    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-none shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
            <div className="w-12 h-12 bg-green-100 rounded-none flex items-center justify-center mb-6 group-hover:bg-green-200 transition-colors duration-300">
          ...
          <div className="bg-white p-8 rounded-none shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
            <div className="w-12 h-12 bg-blue-100 rounded-none flex items-center justify-center mb-6 group-hover:bg-blue-200 transition-colors duration-300">
          ...
          <div className="bg-white p-8 rounded-none shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
            <div className="w-12 h-12 bg-purple-100 rounded-none flex items-center justify-center mb-6 group-hover:bg-purple-200 transition-colors duration-300">
